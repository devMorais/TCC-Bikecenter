...
class Helpers
{
    ...
    public static function validarTelefone($telefone)
    {
        ...
        if (strlen($telefone) === 10 || strlen($telefone) === 11) {
            ...
            $dddValidos = ['11', '12', '13', '14', '15', '16', '17', '18', '19', '21', '22', '24', '27', '28', '31', '32', '33', '34', '35', '37', '38', '41', '42', '43', '44', '45', '46', '47', '48', '49', '51', '53', '54', '55', '61', '62', '63', '64', '65', '66', '67', '68', '69', '71', '73', '74', '75', '77', '79', '81', '82', '83', '84', '85', '86', '87', '88', '89', '91', '92', '93', '94', '95', '96', '97', '98', '99'];
    ...
    public static function validarSenha(string $senha): bool
    {
        ...
        if (!preg_match('/[A-Z]/', $senha)) {
            return false; // Sem letra maiúscula
        }

        // Verifica se a senha contém pelo menos um caractere especial
        if (!preg_match('/[!@#$%^&*()\-_=+{};:,<.>?]/', $senha)) {
            return false; // Sem caractere especial
        }
    ...
    public static function validarCpf(string $cpf): bool
    {
        ...
        if (mb_strlen($cpf) != 11 or preg_match('/(\d)\1{10}/', $cpf)) {
            ...
            $mensagem->erro('O CPF precisa ter 11 digitos')->flash();
            self::redirecionar('cadastro');
        }
        for ($t = 9; $t < 11; $t++) {
            for ($d = 0, $c = 0; $c < $t; $c++) {
                $d += $cpf[$c] * (($t + 1) - $c);
            ...
            if ($cpf[$c] != $d) {
                $mensagem = new Mensagem();
                $mensagem->erro('CPF Inválido')->flash();
                self::redirecionar('cadastro');
            }
        }
        return true;
