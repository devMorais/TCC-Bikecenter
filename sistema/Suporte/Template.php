...
use sistema\Controlador\CarrinhoControlador;
...
class Template
{
    ...
    private function helpers(): void
    {
        array(
            ...
            $this->twig->addFunction(
                    new \Twig\TwigFunction('QtdCarrinho', function () {
                                return CarrinhoControlador::QtdCarrinho();
                            })
            ),
            $this->twig->addFunction(
            ...
            $this->twig->addFunction(
                    new \Twig\TwigFunction('valorTotalCarrinho', function () {
                                return CarrinhoControlador::valorTotalCarrinho();
                            })
            ),
            $this->twig->addFunction(
                    new \Twig\TwigFunction('qtdProduto', function ($idProduto) {
                                return VendasControlador::qtdProduto($idProduto);
                            })
            )
        );
    }
